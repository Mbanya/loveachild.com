...
<head>
    ...
    <title>Love a Child Initiative</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
{{--                            @include('admin.layouts.email_template_social')--}}
                        ...
                        <br>
                        <span class="ios-footer" style=" text-align:center;display: block;"> © Copyright {{ date('Y')}} LoveaChild.com - All Rights Reserved </span> <br>
                        <br></td>
                </tr>
            </table>
